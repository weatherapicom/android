...
public class ForecastCondition {
  ...
  public boolean equals(Object o) {
    ...
    return (this.text == null ? forecastCondition.text == null : this.text.equals(forecastCondition.text)) &&
        (this.icon == null ? forecastCondition.icon == null : this.icon.equals(forecastCondition.icon)) &&
        (this.code == null ? forecastCondition.code == null : this.code.equals(forecastCondition.code));
  }
