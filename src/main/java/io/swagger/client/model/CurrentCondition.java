...
public class CurrentCondition {
  ...
  public boolean equals(Object o) {
    ...
    return (this.text == null ? currentCondition.text == null : this.text.equals(currentCondition.text)) &&
        (this.icon == null ? currentCondition.icon == null : this.icon.equals(currentCondition.icon)) &&
        (this.code == null ? currentCondition.code == null : this.code.equals(currentCondition.code));
  }
