...
public class MarineHour {
  ...
  public boolean equals(Object o) {
    ...
    return (this.timeEpoch == null ? marineHour.timeEpoch == null : this.timeEpoch.equals(marineHour.timeEpoch)) &&
        (this.time == null ? marineHour.time == null : this.time.equals(marineHour.time)) &&
        (this.tempC == null ? marineHour.tempC == null : this.tempC.equals(marineHour.tempC)) &&
        (this.tempF == null ? marineHour.tempF == null : this.tempF.equals(marineHour.tempF)) &&
        (this.isDay == null ? marineHour.isDay == null : this.isDay.equals(marineHour.isDay)) &&
        (this.condition == null ? marineHour.condition == null : this.condition.equals(marineHour.condition)) &&
        (this.windMph == null ? marineHour.windMph == null : this.windMph.equals(marineHour.windMph)) &&
        (this.windKph == null ? marineHour.windKph == null : this.windKph.equals(marineHour.windKph)) &&
        (this.windDegree == null ? marineHour.windDegree == null : this.windDegree.equals(marineHour.windDegree)) &&
        (this.windDir == null ? marineHour.windDir == null : this.windDir.equals(marineHour.windDir)) &&
        (this.pressureMb == null ? marineHour.pressureMb == null : this.pressureMb.equals(marineHour.pressureMb)) &&
        (this.pressureIn == null ? marineHour.pressureIn == null : this.pressureIn.equals(marineHour.pressureIn)) &&
        (this.precipMm == null ? marineHour.precipMm == null : this.precipMm.equals(marineHour.precipMm)) &&
        (this.precipIn == null ? marineHour.precipIn == null : this.precipIn.equals(marineHour.precipIn)) &&
        (this.humidity == null ? marineHour.humidity == null : this.humidity.equals(marineHour.humidity)) &&
        (this.cloud == null ? marineHour.cloud == null : this.cloud.equals(marineHour.cloud)) &&
        (this.feelslikeC == null ? marineHour.feelslikeC == null : this.feelslikeC.equals(marineHour.feelslikeC)) &&
        (this.feelslikeF == null ? marineHour.feelslikeF == null : this.feelslikeF.equals(marineHour.feelslikeF)) &&
        (this.windchillC == null ? marineHour.windchillC == null : this.windchillC.equals(marineHour.windchillC)) &&
        (this.windchillF == null ? marineHour.windchillF == null : this.windchillF.equals(marineHour.windchillF)) &&
        (this.heatindexC == null ? marineHour.heatindexC == null : this.heatindexC.equals(marineHour.heatindexC)) &&
        (this.heatindexF == null ? marineHour.heatindexF == null : this.heatindexF.equals(marineHour.heatindexF)) &&
        (this.dewpointC == null ? marineHour.dewpointC == null : this.dewpointC.equals(marineHour.dewpointC)) &&
        (this.dewpointF == null ? marineHour.dewpointF == null : this.dewpointF.equals(marineHour.dewpointF)) &&
        (this.willItRain == null ? marineHour.willItRain == null : this.willItRain.equals(marineHour.willItRain)) &&
        (this.chanceOfRain == null ? marineHour.chanceOfRain == null : this.chanceOfRain.equals(marineHour.chanceOfRain)) &&
        (this.willItSnow == null ? marineHour.willItSnow == null : this.willItSnow.equals(marineHour.willItSnow)) &&
        (this.chanceOfSnow == null ? marineHour.chanceOfSnow == null : this.chanceOfSnow.equals(marineHour.chanceOfSnow)) &&
        (this.visKm == null ? marineHour.visKm == null : this.visKm.equals(marineHour.visKm)) &&
        (this.visMiles == null ? marineHour.visMiles == null : this.visMiles.equals(marineHour.visMiles)) &&
        (this.gustMph == null ? marineHour.gustMph == null : this.gustMph.equals(marineHour.gustMph)) &&
        (this.gustKph == null ? marineHour.gustKph == null : this.gustKph.equals(marineHour.gustKph)) &&
        (this.sigHtMt == null ? marineHour.sigHtMt == null : this.sigHtMt.equals(marineHour.sigHtMt)) &&
        (this.swellHtMt == null ? marineHour.swellHtMt == null : this.swellHtMt.equals(marineHour.swellHtMt)) &&
        (this.swellHtFt == null ? marineHour.swellHtFt == null : this.swellHtFt.equals(marineHour.swellHtFt)) &&
        (this.swellDir == null ? marineHour.swellDir == null : this.swellDir.equals(marineHour.swellDir)) &&
        (this.swellDir16Point == null ? marineHour.swellDir16Point == null : this.swellDir16Point.equals(marineHour.swellDir16Point)) &&
        (this.swellPeriodSecs == null ? marineHour.swellPeriodSecs == null : this.swellPeriodSecs.equals(marineHour.swellPeriodSecs)) &&
        (this.uv == null ? marineHour.uv == null : this.uv.equals(marineHour.uv));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.sigHtMt == null ? 0: this.sigHtMt.hashCode());
    result = 31 * result + (this.swellHtMt == null ? 0: this.swellHtMt.hashCode());
    result = 31 * result + (this.swellHtFt == null ? 0: this.swellHtFt.hashCode());
    result = 31 * result + (this.swellDir == null ? 0: this.swellDir.hashCode());
    result = 31 * result + (this.swellDir16Point == null ? 0: this.swellDir16Point.hashCode());
    result = 31 * result + (this.swellPeriodSecs == null ? 0: this.swellPeriodSecs.hashCode());
